...
let rec typecheck_type_constructor_arg (types_env : types_env)
  ...
  | Ast_types.TEArrow (_, input_type, output_type) ->
      ...
      typecheck_type_constructor_arg types_env output_type
  | _ -> Ok ()
...
let rec typecheck_type_constructor_args (types_env : types_env)
  ...
  | constructor_arg :: constructor_args ->
      let open Result in
      typecheck_type_constructor_arg types_env constructor_arg >>= fun () ->
...
let typecheck_type_constructor (types_env : types_env)
  ...
  assert_constructor_not_in_constructors_env loc constructor_name
    constructors_env
  >>= fun () ->
  typecheck_type_constructor_args types_env constructor_args >>= fun () ->
...
let rec typecheck_type_constructors (types_env : types_env)
  ...
  | type_constructor :: type_constructors ->
      let open Result in
      typecheck_type_constructor types_env constructors_env constructors_type
        type_constructor
...
let typecheck_type_defn (types_env : types_env)
  ...
  let open Result in
  assert_custom_type_not_in_types_env loc type_name types_env >>= fun () ->
  typecheck_type_constructors extended_types_env constructors_env [] type_name
    type_constructors
...
let rec typecheck_type_defns (types_env : types_env)
    (constructors_env : constructors_env)
  ...
  | type_defn :: type_defns ->
      ...
      typecheck_type_defns types_env constructors_env
