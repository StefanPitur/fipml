...
let assert_custom_type_in_types_env (type_name : Type_name.t) (types_env : types_env) : unit Or_error.t = 
  let open Result in
...
let assert_custom_type_not_in_types_env (type_name : Type_name.t) (types_env : types_env) : unit Or_error.t =
  let open Result in
...
let assert_constructor_in_constructors_env (constructor_name : Constructor_name.t) (constructors_env : constructors_env) : unit Or_error.t =
...
let assert_constructor_not_in_constructors_env (constructor_name : Constructor_name.t) (constructors_env : constructors_env) : unit Or_error.t =
  let matched_constructors = filter_constructors_env_by_name constructor_name constructors_env in
  match matched_constructors with
  | [] -> Ok ()
  | _ -> Or_error.of_exn (ConstructorAlreadyExists)

let get_constructor_by_name (constructor_name : Constructor_name.t) (constructors_env : constructors_env) : constructor_env_entry Or_error.t =
  let matched_constructors = filter_constructors_env_by_name constructor_name constructors_env in
  match matched_constructors with
  | [] -> Or_error.of_exn(ConstructorNotFound)
