  ...
  let simple_custom_type = 
    TType (mock_loc, Type_name.of_string "simple_custom_type", [
      ...
      TTypeConstructor(mock_loc, Constructor_name.of_string "C2", [
        TEUnit mock_loc; TEInt mock_loc; TEBool mock_loc; TEOption (mock_loc, TEUnit mock_loc);
        TEArrow (mock_loc, TEUnit mock_loc, TEInt mock_loc); TECustom (mock_loc, Type_name.of_string "simple_custom_type")
      ])
    ])
  in 
